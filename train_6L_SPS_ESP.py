...
from P4DCNN_model import p4dcnn_6L
import keras.backend as K
import pickle

MODEL_CONFIG = '6L_SPS_ESP'
...
def MSE_ESP_loss(y_true, y_pred):

    spsLoss = SPS_loss(y_true, y_pred)

    return LOSS_LAMDA * spsLoss + K.mean(K.square(y_pred - y_true))
...
model = p4dcnn_6L(lr_angular_size=LR_ANGULAR_SIZE,
                  height=PATCH_SIZE,
                  width=PATCH_SIZE,
                  channel=CHANNEL,
